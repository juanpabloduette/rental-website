 ...
 * ====================================================================== */    
    ...
    WhatsappChatSupport.DEFAULTS = {
        ...
        timezone                    :   'America/Buenos Aires', // When using the date and time from the user browser you can transform it to your current timezone (in case your user is in a different timezone)
        notAvailableMsg             :   'Atendemos de lunes a viernes de 9:00hs. a 18:00hs.', // message when its not an available day or once the available hours have passed
        almostAvailableMsg          :   'Lunes a viernes de 9:00hs. a 18:00hs.', // if today is an available day and before the time starts
        dialogNotAvailableMsg       :   'Lunes a viernes de 9:00hs. a 18:00hs.', // message when its not an available day or once the available hours have passed
        dialogAlmostAvailableMsg    :   'Lunes a viernes de 9:00hs. a 18:00hs. , Sábados de 9 a 12hs.', // if today is an available day and before the time starts
